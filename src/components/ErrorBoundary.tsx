      ...
      return (
        <div className="glass-panel p-8 text-center border border-red-500/20">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-red-500/10 border border-red-500/20 text-red-400 hover:bg-red-500/20 transition-colors text-sm"
          >
